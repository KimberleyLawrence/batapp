      ...
      <div className="w-full p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-6 dark:bg-gray-800 dark:border-gray-700">
        ...
        <div>
          <Link to="#" className="inline-flex items-center text-xs font-normal text-gray-500 hover:underline dark:text-gray-400">
            ...
            Why do I need to connect with my wallet?</Link>
        </div>
      </div >
